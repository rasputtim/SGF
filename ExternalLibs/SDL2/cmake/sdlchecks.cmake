...
macro(CheckDLOPEN)
  ...
  if (HAVE_DLOPEN)
    ...
    set(SDL2_SOURCE_FILES ${SDL2_SOURCE_FILES} ${DLOPEN_SOURCES})
...
macro(CheckOSS)
  if(OSS)
    ...
    if(OSS_FOUND)
      ...
      set(SDL2_SOURCE_FILES ${SDL2_SOURCE_FILES} ${OSS_SOURCES})
...
macro(CheckALSA)
  if(ALSA)
    ...
    if(HAVE_LIBASOUND)
      ...
      set(SDL2_SOURCE_FILES ${SDL2_SOURCE_FILES} ${ALSA_SOURCES})
...
macro(CheckPulseAudio)
  if(PULSEAUDIO)
    ...
    if(PKG_PULSEAUDIO_FOUND)
      ...
      set(SDL2_SOURCE_FILES ${SDL2_SOURCE_FILES} ${PULSEAUDIO_SOURCES})
...
macro(CheckJACK)
  if(JACK)
    ...
    if(PKG_JACK_FOUND)
      ...
      set(SDL2_SOURCE_FILES ${SDL2_SOURCE_FILES} ${JACK_SOURCES})
...
macro(CheckESD)
  if(ESD)
    ...
    if(PKG_ESD_FOUND)
      ...
      set(SDL2_SOURCE_FILES ${SDL2_SOURCE_FILES} ${ESD_SOURCES})
...
macro(CheckARTS)
  if(ARTS)
    ...
    if(ARTS_CONFIG)
      ...
      set(SDL2_SOURCE_FILES ${SDL2_SOURCE_FILES} ${ARTS_SOURCES})
...
macro(CheckNAS)
  if(NAS)
    ...
    if(HAVE_NAS_H AND D_NAS_LIB)
      ...
      set(SDL2_SOURCE_FILES ${SDL2_SOURCE_FILES} ${NAS_SOURCES})
...
macro(CheckSNDIO)
  if(SNDIO)
    ...
    if(HAVE_SNDIO_H AND D_SNDIO_LIB)
      ...
      set(SDL2_SOURCE_FILES ${SDL2_SOURCE_FILES} ${SNDIO_SOURCES})
...
macro(CheckFusionSound)
  if(FUSIONSOUND)
    ...
    if(PKG_FUSIONSOUND_FOUND)
      ...
      set(SDL2_SOURCE_FILES ${SDL2_SOURCE_FILES} ${FUSIONSOUND_SOURCES})
...
macro(CheckX11)
  if(VIDEO_X11)
    ...
    if(X11_LIB)
      ...
      set(SDL2_SOURCE_FILES ${SDL2_SOURCE_FILES} ${X11_SOURCES})
...
macro(CheckMir)
    if(VIDEO_MIR)
        ...
        if (MIR_LIB AND MIR_TOOLKIT_FOUND AND EGL_FOUND AND XKB_FOUND)
            ...
            set(SDL2_SOURCE_FILES ${SDL2_SOURCE_FILES} ${MIR_SOURCES})
...
macro(WaylandProtocolGen _SCANNER _XML _PROTL)
    ...
    set(SDL2_SOURCE_FILES ${SDL2_SOURCE_FILES} "${_WAYLAND_PROT_C_CODE}")
endmacro()
...
macro(CheckWayland)
  if(VIDEO_WAYLAND)
    ...
    if(WAYLAND_FOUND)
      ...
      set(SDL2_SOURCE_FILES ${SDL2_SOURCE_FILES} ${WAYLAND_SOURCES})
...
macro(CheckCOCOA)
  if(VIDEO_COCOA)
    ...
    if(HAVE_VIDEO_COCOA)
      ...
      set(SDL2_SOURCE_FILES ${SDL2_SOURCE_FILES} ${COCOA_SOURCES})
...
macro(CheckDirectFB)
  if(VIDEO_DIRECTFB)
    ...
    if(PKG_DIRECTFB_FOUND)
      ...
      set(SDL2_SOURCE_FILES ${SDL2_SOURCE_FILES} ${DIRECTFB_SOURCES})
...
macro(CheckVivante)
  if(VIDEO_VIVANTE)
    ...
    if(HAVE_VIDEO_VIVANTE_VDK OR HAVE_VIDEO_VIVANTE_EGL_FB)
      ...
      set(SDL2_SOURCE_FILES ${SDL2_SOURCE_FILES} ${VIVANTE_SOURCES})
...
message(STATUS "Will Check PTHREADS")
# Requires:
# - nada
# Optional:
# - THREADS opt
...
macro(CheckPTHREAD)
  if(PTHREADS)
    ...
    if(HAVE_PTHREADS)
      ...
      set(SDL2_SOURCE_FILES ${SDL2_SOURCE_FILES}
      ...
      message (STATUS "Will Add THREAD SOURCE FILES")    
      if(HAVE_PTHREADS_SEM)
        set(SDL2_SOURCE_FILES ${SDL2_SOURCE_FILES}
...
macro(CheckUSBHID)
  ...
  if(HAVE_USBHID)
    ...
    set(SDL2_SOURCE_FILES ${SDL2_SOURCE_FILES} ${BSD_JOYSTICK_SOURCES})
...
macro(CheckRPI)
  if(VIDEO_RPI)
    ...
    if(SDL_VIDEO AND HAVE_VIDEO_RPI)
      ...
      set(SDL2_SOURCE_FILES ${SDL2_SOURCE_FILES} ${VIDEO_RPI_SOURCES})
...
macro(CheckKMSDRM)
  if(VIDEO_KMSDRM)
    ...
    if(KMSDRM_FOUND)
      ...
      set(SDL2_SOURCE_FILES ${SDL2_SOURCE_FILES} ${KMSDRM_SOURCES})
