...
#
  ...
  TRY_COMPILE(CMAKE_TEST_BITS_ATOMIC
    ${CMAKE_BINARY_DIR}
    ${CMAKE_CURRENT_SOURCE_DIR}/cmake/TestBitsAtomic.cpp
    OUTPUT_VARIABLE OUTPUT)

TRY_COMPILE(CMAKE_TEST_BITS_ATOMIC_CXX
  ${CMAKE_BINARY_DIR}
  ${CMAKE_CURRENT_SOURCE_DIR}/cmake/TestBitsAtomicCXX.cpp
  OUTPUT_VARIABLE OUTPUT)
...
IF(HAVE_GCC_BITS_ATOMIC_VOID)
 ...
 file(APPEND ${CMAKE_CURRENT_SOURCE_DIR}/config.h "#define KOL_HAVE_GCC_BITS_ATOMIC_CXX 1\n" )
 ELSE(HAVE_GCC_BITS_ATOMIC_CXX)
 file(APPEND ${CMAKE_CURRENT_SOURCE_DIR}/config.h "#define KOL_HAVE_GCC_BITS_ATOMIC 1\n" )
