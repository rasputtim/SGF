...
#==============CANCEL======================
  ...
  TRY_COMPILE(CMAKE_TEST_PTHREAD_CANCEL
    ${CMAKE_BINARY_DIR}
    ${CMAKE_CURRENT_SOURCE_DIR}/cmake/TestPthreadCancel.cpp
 ...
 #========SUSPEND======================== 
  ...
  TRY_COMPILE(CMAKE_TEST_PTHREAD_SUSPEND
    ${CMAKE_BINARY_DIR}
    ${CMAKE_CURRENT_SOURCE_DIR}/cmake/TestPthreadSuspend.cpp
    LINK_LIBRARIES "-lpthread"
    OUTPUT_VARIABLE OUTPUT )
...
#========EXPIRATION========================   
  ...
  TRY_COMPILE(CMAKE_TEST_PTHREAD_EXPIRATION_NP
    ${CMAKE_BINARY_DIR}
    ${CMAKE_CURRENT_SOURCE_DIR}/cmake/TestPthreadExpirationNP.cpp
    OUTPUT_VARIABLE OUTPUT)
 ...
 #========MUTEX TYPE========================  
  ...
  TRY_COMPILE(CMAKE_TEST_PTHREAD_TYPE_REC
    ${CMAKE_BINARY_DIR}
    ${CMAKE_CURRENT_SOURCE_DIR}/cmake/TestPthreadMutexTypeREC.cpp
    OUTPUT_VARIABLE OUTPUT)
  ...
  TRY_COMPILE(CMAKE_TEST_PTHREAD_TYPE_REC_NP
    ${CMAKE_BINARY_DIR}
    ${CMAKE_CURRENT_SOURCE_DIR}/cmake/TestPthreadMutexTypeREC_NP.cpp
    OUTPUT_VARIABLE OUTPUT)
  ...
  TRY_COMPILE(CMAKE_TEST_PTHREAD_TYPE_INITIALIZER_NP
    ${CMAKE_BINARY_DIR}
    ${CMAKE_CURRENT_SOURCE_DIR}/cmake/TestPthreadMutexTypeINI_NP.cpp
    OUTPUT_VARIABLE OUTPUT)
  ...
  TRY_COMPILE(CMAKE_TEST_PTHREAD_TYPE_COUNTING_FAST
    ${CMAKE_BINARY_DIR}
    ${CMAKE_CURRENT_SOURCE_DIR}/cmake/TestPthreadMutexTypeCOU.cpp
    OUTPUT_VARIABLE OUTPUT)
...
if(HAVE_PTHREADS_SEM)
file(APPEND ${CMAKE_CURRENT_SOURCE_DIR}/config.h "#define KOL_HAVE_PTHREAD_SEMAPHORE 1\n" )
    if(HAVE_SEM_TIMEDWAIT)
    file(APPEND ${CMAKE_CURRENT_SOURCE_DIR}/config.h "#define KOL_HAVE_PTHREAD_SEMAPHORE_TIMEDWAIT 1\n" )
...
IF(SUSPEND_FOUND)
file(APPEND ${CMAKE_CURRENT_SOURCE_DIR}/config.h "#define KOL_HAVE_PTHREAD_SUSPEND 1\n" )
ELSE(SUSPEND_FOUND)
ENDIF(SUSPEND_FOUND)

IF(CANCEL_FOUND)
file(APPEND ${CMAKE_CURRENT_SOURCE_DIR}/config.h "#define KOL_HAVE_PTHREAD_CANCEL 1\n" )
ELSE(CANCEL_FOUND)
ENDIF(CANCEL_FOUND)
...
file(APPEND ${CMAKE_CURRENT_SOURCE_DIR}/config.h "#define KOL_PTHREAD_GET_EXPIRATION_NP 1\n" )
...
file(APPEND ${CMAKE_CURRENT_SOURCE_DIR}/config.h "#define KOL_THREAD_PTHREAD_RECURSIVE_MUTEX 1\n" )
ELSEIF(MUTEX_LINUX)
file(APPEND ${CMAKE_CURRENT_SOURCE_DIR}/config.h "#define KOL_THREAD_PTHREAD_RECURSIVE_MUTEX 1\n" )
ELSEIF(NUTEX_CONTINUING)
file(APPEND ${CMAKE_CURRENT_SOURCE_DIR}/config.h "#define KOL_THREAD_PTHREAD_RECURSIVE_MUTEX 1\n" )
file(APPEND ${CMAKE_CURRENT_SOURCE_DIR}/config.h "#define MUTEX_TYPE_COUNTING_FAST 1\n" )
ENDIF()
...
file(APPEND ${CMAKE_CURRENT_SOURCE_DIR}/config.h "#define KOL_THREAD_PTHREAD_RECURSIVE_MUTEX_NP 1\n" ) 
