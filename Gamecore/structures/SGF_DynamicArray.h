...
#include "../exceptions/SGF_Error.h"
 ...
 *
 * \brief Array Din�mico
 *
 * � bom quando voc� sabe o tamanho do array
 * N�o funciona como ao container Vector que voc� pode adicionar alementos
 * mas � muito mais r�pido
 * \note � poss�vel um resize do array din�micamente
 *
...
// Inicializa o item que significa valor nulo para Types que n�o possuem default construtor
...
/**
 * @brief aumenta o tamanho do array, criando elementos vazios e copiando os j� existentes
 *
 * @param newsize o novo tamanho do array
 * \note n�o diminui o array
 */
...
/**
 * @brief operador de c�pia do array
 *
...
/**
 * @brief insere um elemento numa certa posi��o
 *
 * @param offset a posi��o onde inserir o elemento
...
void insert_at(int offset, Type e){
	...
	try {
        Type *temp;
		if (sizeX>= _capacity) {
			//n�o usa resize aqui para n�o copiar os elementos duas vezes
			//cria um novo array
			_capacity = sizeX +128;
 ...
 *
 * @param offset a posi��o do elemento a ser torcado
 ...
 *
 * @param offset a posi��o do elemento
 */
 ...
 * @param offset a posi��o do elemento a remover
 */
...
/**
 * @brief remove o �ltimo elemento do array
 *
 */
void removeLast() {
...
/**
 * @brief o n�mero de elementos no array
 *
 */
...
/**
 * @brief o tamanho m�ximo do array
 *
 */
int capacity() {return _capacity;};
/**
 * @brief limpa o array, deleta os dados e reseta as vari�veis
 ...
 * \ingroup SGF_Util
 *
 * \brief Array Din�mico de duas dimenss�es
 *
 * \author (last to touch it) $Autor: Rasputtim $
 *
 * \version 1.0 $Revision: 1.0 $
 ...
 * \ingroup SGF_Util
 *
 * \brief Array Din�mico de tr�s dimenss�es
 *
 * \note n�o testado ainda
 *
 * \author (last to touch it) $Autor: Rasputtim $
 *
 * \version 1.0 $Revision: 1.0 $
