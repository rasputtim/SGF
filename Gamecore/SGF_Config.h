...
#endif
#define SGF_USE_INTERNAL_TIMER // usa o timer interno ao inv�s do SDL

#define USE_FASTEVENTS // utiliza as fun��es de eventos do FastEvents, que s�o thread safe, ao inv�s de usar a biblioteca normal do SDL
