...
public:
	...
	const CVector3D &	Normal() const;					// reference to const normal
	CVector3D &		Normal();							// reference to normal
...
SGF_INLINE_FORCED CPlane::CPlane() {
}
...
SGF_INLINE_FORCED void CPlane::Zero() {
	a = b = c = d = 0.0f;
}
...
SGF_INLINE_FORCED const CVector3D &CPlane::Normal() const {
	return *reinterpret_cast<const CVector3D *>(&a);
}

SGF_INLINE_FORCED CVector3D &CPlane::Normal() {
...
SGF_INLINE_FORCED bool CPlane::FixDegenerateNormal() {
...
SGF_INLINE_FORCED float CPlane::Dist() const {
	return -d;
}
...
SGF_INLINE_FORCED int CPlane::GetDimension() const {
	return 4;
}

SGF_INLINE_FORCED const CVector4D &CPlane::ToVec4() const {
	return *reinterpret_cast<const CVector4D *>(&a);
}

SGF_INLINE_FORCED CVector4D &CPlane::ToVec4() {
	return *reinterpret_cast<CVector4D *>(&a);
}

SGF_INLINE_FORCED const float *CPlane::ToFloatPtr() const {
	return reinterpret_cast<const float *>(&a);
}

SGF_INLINE_FORCED float *CPlane::ToFloatPtr() {
