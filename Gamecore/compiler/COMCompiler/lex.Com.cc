...
{ yylval->stringVal = new string("command.time"); SGF::Debug::debug(SGF::Debug::compilers,__FUNCTION__) <<"Lexer Token: "<< "KEY_TIME" <<endl; 
	return token::KEY_TIME;}
	YY_BREAK
case 47:
YY_RULE_SETUP
#line 169 "..\\comcompiler\\comscanner.l"
{ yylval->stringVal = new string("command.buffer.time"); SGF::Debug::debug(SGF::Debug::compilers,__FUNCTION__) <<"Lexer Token: "<< "KEY_BUFFERTIME" <<endl; 
...
{ yylval->stringVal = new string("buffer.time"); SGF::Debug::debug(SGF::Debug::compilers,__FUNCTION__) <<"Lexer Token: "<< "KEY_BUFFERTIME" <<endl; 
	return token::KEY_BUFFERTIME;}
	YY_BREAK
case 50:
YY_RULE_SETUP
#line 177 "..\\comcompiler\\comscanner.l"
{ yylval->stringVal = new string("name"); SGF::Debug::debug(SGF::Debug::compilers,__FUNCTION__) <<"Lexer Token: "<< "KEY_NAME" <<endl; 
	return token::KEY_NAME;}
	YY_BREAK
case 51:
YY_RULE_SETUP
#line 180 "..\\comcompiler\\comscanner.l"
{ yylval->stringVal = new string("time"); SGF::Debug::debug(SGF::Debug::compilers,__FUNCTION__) <<"Lexer Token: "<< "KEY_TIME: " << *yylval->stringVal <<endl; 
	return token::KEY_TIME;}
	YY_BREAK
case 52:
YY_RULE_SETUP
#line 183 "..\\comcompiler\\comscanner.l"
{ yylval->stringVal = new string("defaults"); SGF::Debug::debug(SGF::Debug::compilers,__FUNCTION__) <<"Lexer Token: "<< "KEY_DEFAULTS" <<endl; 
