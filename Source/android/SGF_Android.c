...
#define SGF_JAVA_PREFIX                                 org_rasputtim_sgffabric
#define CONCAT1(prefix, class, function)                CONCAT2(prefix, class, function)
#define CONCAT2(prefix, class, function)                Java_ ## prefix ## _ ## class ## _ ## function
#define SGF_JAVA_INTERFACE(function)                    CONCAT1(SGF_JAVA_PREFIX, SGFActivity, function)
#define SGF_JAVA_AUDIO_INTERFACE(function)              CONCAT1(SGF_JAVA_PREFIX, SGFAudioManager, function)
#define SGF_JAVA_CONTROLLER_INTERFACE(function)         CONCAT1(SGF_JAVA_PREFIX, SGFControllerManager, function)
#define SGF_JAVA_INTERFACE_INPUT_CONNECTION(function)   CONCAT1(SGF_JAVA_PREFIX, SGFInputConnection, function)


/* Java class SGFActivity */
JNIEXPORT void JNICALL SGF_JAVA_INTERFACE(nativeSetupJNI)(
        JNIEnv* mEnv, jclass cls);

JNIEXPORT int JNICALL SGF_JAVA_INTERFACE(nativeRunMain)(
        JNIEnv* env, jclass cls,
        jstring library, jstring function, jobject array);

JNIEXPORT void JNICALL SGF_JAVA_INTERFACE(onNativeDropFile)(
        JNIEnv* env, jclass jcls,
        jstring filename);

JNIEXPORT void JNICALL SGF_JAVA_INTERFACE(onNativeResize)(
        JNIEnv* env, jclass jcls,
        jint width, jint height, jint format, jfloat rate);
      

JNIEXPORT void JNICALL SGF_JAVA_INTERFACE(onNativeSurfaceChanged)(
        JNIEnv* env, jclass jcls);

JNIEXPORT void JNICALL SGF_JAVA_INTERFACE(onNativeSurfaceDestroyed)(
        JNIEnv* env, jclass jcls);

JNIEXPORT void JNICALL SGF_JAVA_INTERFACE(onNativeKeyDown)(
        JNIEnv* env, jclass jcls,
        jint keycode);

JNIEXPORT void JNICALL SGF_JAVA_INTERFACE(onNativeKeyUp)(
        JNIEnv* env, jclass jcls,
        jint keycode);

JNIEXPORT void JNICALL SGF_JAVA_INTERFACE(onNativeKeyboardFocusLost)(
        JNIEnv* env, jclass jcls);

JNIEXPORT void JNICALL SGF_JAVA_INTERFACE(onNativeTouch)(
        JNIEnv* env, jclass jcls,
        jint touch_device_id_in, jint pointer_finger_id_in,
        jint action, jfloat x, jfloat y, jfloat p);

JNIEXPORT void JNICALL SGF_JAVA_INTERFACE(onNativeMouse)(
        JNIEnv* env, jclass jcls,
        jint button, jint action, jfloat x, jfloat y);

JNIEXPORT void JNICALL SGF_JAVA_INTERFACE(onNativeAccel)(
        JNIEnv* env, jclass jcls,
        jfloat x, jfloat y, jfloat z);

JNIEXPORT void JNICALL SGF_JAVA_INTERFACE(onNativeClipboardChanged)(
        JNIEnv* env, jclass jcls);

JNIEXPORT void JNICALL SGF_JAVA_INTERFACE(nativeLowMemory)(
        JNIEnv* env, jclass cls);

JNIEXPORT void JNICALL SGF_JAVA_INTERFACE(nativeQuit)(
        JNIEnv* env, jclass cls);

JNIEXPORT void JNICALL SGF_JAVA_INTERFACE(nativePause)(
        JNIEnv* env, jclass cls);

JNIEXPORT void JNICALL SGF_JAVA_INTERFACE(nativeResume)(
        JNIEnv* env, jclass cls);

JNIEXPORT jstring JNICALL SGF_JAVA_INTERFACE(nativeGetHint)(
        JNIEnv* env, jclass cls,
        jstring name);

JNIEXPORT void JNICALL SGF_JAVA_INTERFACE(nativeSetenv)(
        JNIEnv* env, jclass cls,
        jstring name, jstring value);

JNIEXPORT void JNICALL SGF_JAVA_INTERFACE(nativeEnvironmentVariablesSet)(
        JNIEnv* env, jclass cls);

/* Java class SGFInputConnection */
JNIEXPORT void JNICALL SGF_JAVA_INTERFACE_INPUT_CONNECTION(nativeCommitText)(
        JNIEnv* env, jclass cls,
        jstring text, jint newCursorPosition);

JNIEXPORT void JNICALL SGF_JAVA_INTERFACE_INPUT_CONNECTION(nativeSetComposingText)(
        JNIEnv* env, jclass cls,
        jstring text, jint newCursorPosition);

/* Java class SGFAudioManager */
JNIEXPORT void JNICALL SGF_JAVA_AUDIO_INTERFACE(nativeSetupJNI)(
        JNIEnv *env, jclass jcls);

/* Java class SGFControllerManager */
JNIEXPORT void JNICALL SGF_JAVA_CONTROLLER_INTERFACE(nativeSetupJNI)(
        JNIEnv *env, jclass jcls);

JNIEXPORT jint JNICALL SGF_JAVA_CONTROLLER_INTERFACE(onNativePadDown)(
        JNIEnv* env, jclass jcls,
        jint device_id, jint keycode);

JNIEXPORT jint JNICALL SGF_JAVA_CONTROLLER_INTERFACE(onNativePadUp)(
        JNIEnv* env, jclass jcls,
        jint device_id, jint keycode);

JNIEXPORT void JNICALL SGF_JAVA_CONTROLLER_INTERFACE(onNativeJoy)(
        JNIEnv* env, jclass jcls,
        jint device_id, jint axis, jfloat value);

JNIEXPORT void JNICALL SGF_JAVA_CONTROLLER_INTERFACE(onNativeHat)(
        JNIEnv* env, jclass jcls,
        jint device_id, jint hat_id, jint x, jint y);

JNIEXPORT jint JNICALL SGF_JAVA_CONTROLLER_INTERFACE(nativeAddJoystick)(
        JNIEnv* env, jclass jcls,
        jint device_id, jstring device_name, jstring device_desc, jint is_accelerometer,
        jint nbuttons, jint naxes, jint nhats, jint nballs);

JNIEXPORT jint JNICALL SGF_JAVA_CONTROLLER_INTERFACE(nativeRemoveJoystick)(
        JNIEnv* env, jclass jcls,
        jint device_id);

JNIEXPORT jint JNICALL SGF_JAVA_CONTROLLER_INTERFACE(nativeAddHaptic)(
        JNIEnv* env, jclass jcls,
        jint device_id, jstring device_name);

JNIEXPORT jint JNICALL SGF_JAVA_CONTROLLER_INTERFACE(nativeRemoveHaptic)(
        JNIEnv* env, jclass jcls,
        jint device_id);
...
JNIEXPORT jint JNICALL JNI_OnLoad(JavaVM* vm, void* reserved)
{
    ...
    if (pthread_key_create(&mThreadKey, Android_JNI_ThreadDestroyed) != 0) {
        __android_log_print(ANDROID_LOG_ERROR, "SGF", "Error initializing pthread key");
    }
...
JNIEXPORT void JNICALL SGF_JAVA_INTERFACE(nativeSetupJNI)(JNIEnv* mEnv, jclass cls)
{
    __android_log_print(ANDROID_LOG_VERBOSE, "SGF", "nativeSetupJNI()");
    ...
    if (!midGetNativeSurface ||
       ...
       !midOpenAPKExpansionInputStream || !midGetManifestEnvironmentVariables|| !midGetDisplayDPI) {
        __android_log_print(ANDROID_LOG_WARN, "SGF", "Missing some Java callbacks, do you have the latest version of SGFActivity.java?");
    }

    fidSeparateMouseAndTouch = (*mEnv)->GetStaticFieldID(mEnv, mActivityClass, "mSeparateMouseAndTouch", "Z");

    if (!fidSeparateMouseAndTouch) {
        __android_log_print(ANDROID_LOG_WARN, "SGF", "Missing some Java static fields, do you have the latest version of SGFActivity.java?");
    }
...
JNIEXPORT void JNICALL SGF_JAVA_AUDIO_INTERFACE(nativeSetupJNI)(JNIEnv* mEnv, jclass cls)
{
    __android_log_print(ANDROID_LOG_VERBOSE, "SGF", "AUDIO nativeSetupJNI()");
    ...
    if (!midAudioOpen || !midAudioWriteShortBuffer || !midAudioWriteByteBuffer || !midAudioClose ||
       !midCaptureOpen || !midCaptureReadShortBuffer || !midCaptureReadByteBuffer || !midCaptureClose) {
        __android_log_print(ANDROID_LOG_WARN, "SGF", "Missing some Java callbacks, do you have the latest version of SGFAudioManager.java?");
    }
...
JNIEXPORT void JNICALL SGF_JAVA_CONTROLLER_INTERFACE(nativeSetupJNI)(JNIEnv* mEnv, jclass cls)
{
    __android_log_print(ANDROID_LOG_VERBOSE, "SGF", "CONTROLLER nativeSetupJNI()");
    ...
    if (!midPollInputDevices || !midPollHapticDevices || !midHapticRun) {
        __android_log_print(ANDROID_LOG_WARN, "SGF", "Missing some Java callbacks, do you have the latest version of SGFControllerManager.java?");
    }
...
JNIEXPORT int JNICALL SGF_JAVA_INTERFACE(nativeRunMain)(JNIEnv* env, jclass cls, jstring library, jstring function, jobject array)
{
    int status = -1;
    const char *library_file;
    void *library_handle;

    __android_log_print(ANDROID_LOG_VERBOSE, "SGF", "nativeRunMain()");
    ...
    if (library_handle) {
        ...
        if (SDL_main) {
            ...
            __android_log_print(ANDROID_LOG_ERROR, "SGF", "nativeRunMain(): Couldn't find function %s in library %s", function_name, library_file);
        }
        ...
        __android_log_print(ANDROID_LOG_ERROR, "SGF", "nativeRunMain(): Couldn't load library %s", library_file);
    }
...
/* Surface Created */
JNIEXPORT void JNICALL SGF_JAVA_INTERFACE(onNativeSurfaceChanged)(JNIEnv* env, jclass jcls)
{
    SDL_WindowData *data;
...
/* Surface Destroyed */
JNIEXPORT void JNICALL SGF_JAVA_INTERFACE(onNativeSurfaceDestroyed)(JNIEnv* env, jclass jcls)
{
...
JNIEXPORT void JNICALL SGF_JAVA_INTERFACE(nativePause)(
                                    JNIEnv* env, jclass cls)
{
    __android_log_print(ANDROID_LOG_VERBOSE, "SGF", "nativePause()");
...
JNIEXPORT void JNICALL SGF_JAVA_INTERFACE(nativeResume)(
                                    JNIEnv* env, jclass cls)
{
    __android_log_print(ANDROID_LOG_VERBOSE, "SGF", "nativeResume()");
...
JNIEXPORT void JNICALL SGF_JAVA_INTERFACE_INPUT_CONNECTION(nativeGenerateScancodeForUnichar)(
                                    JNIEnv* env, jclass cls,
                                    jchar chUnicode)
{
...
int Android_JNI_OpenAudioDevice(int iscapture, int sampleRate, int is16Bit, int channelCount, int desiredBufferFrames)
{
    ...
    if (iscapture) {
        __android_log_print(ANDROID_LOG_VERBOSE, "SGF", "SDL audio: opening device for capture");
        ...
        if ((*env)->CallStaticIntMethod(env, mAudioManagerClass, midCaptureOpen, sampleRate, audioBuffer16Bit, audioBufferStereo, desiredBufferFrames) != 0) {
            ...
            __android_log_print(ANDROID_LOG_WARN, "SGF", "SDL audio: error on AudioRecord initialization!");
            return 0;
        }
    } else {
        __android_log_print(ANDROID_LOG_VERBOSE, "SGF", "SDL audio: opening device for output");
        ...
        if ((*env)->CallStaticIntMethod(env, mAudioManagerClass, midAudioOpen, sampleRate, audioBuffer16Bit, audioBufferStereo, desiredBufferFrames) != 0) {
            /* Error during audio initialization */
            __android_log_print(ANDROID_LOG_WARN, "SGF", "SDL audio: error on AudioTrack initialization!");
            return 0;
        }
    }
    ...
    if (jbufobj == NULL) {
        __android_log_print(ANDROID_LOG_WARN, "SGF", "SDL audio: could not allocate an audio buffer!");
        return 0;
    }
...
static int Internal_Android_JNI_FileOpen(SDL_RWops* ctx)
{
    ...
    /* context = SGFActivity.getContext(); */
...
fallback:
        ...
        /* __android_log_print(ANDROID_LOG_DEBUG, "SGF", "Falling back to legacy InputStream method for opening file"); */
...
/* See SGFActivity.java for constants. */
...
int SDL_AndroidGetExternalStorageState(void)
{
    ...
    __android_log_print(ANDROID_LOG_INFO, "SGF", "external storage state: %s", state);
...
void Android_JNI_GetManifestEnvironmentVariables(void)
{
    if (!mActivityClass || !midGetManifestEnvironmentVariables) {
        __android_log_print(ANDROID_LOG_WARN, "SGF", "Request to get environment variables before JNI is ready");
        return;
    }
