...
const float CMath::FLT_EPSILON		= 1.192092896e-07f;

bool		CMath::initialized		= false;
SGF_Dword		CMath::iSqrt[SQRT_TABLE_SIZE];		// inverse square root lookup table
...
void CMath::Init() {
    ...
    for ( int i = 0; i < SQRT_TABLE_SIZE; i++ ) {
        ...
        iSqrt[i] = ((SGF_Dword)(((fo.i + (1<<(SEED_POS-2))) >> SEED_POS) & 0xFF))<<SEED_POS;
    }
    
	iSqrt[SQRT_TABLE_SIZE / 2] = ((SGF_Dword)(0xFF))<<(SEED_POS); 
