...
===============
*/
// calculates arc tangent of a vector with 16 bits of precision, based on atan16 in CMath
...
inline void FastScalarInvSqrt_x3( float *arg1, float *arg2, float *arg3 ) {
	...
	*arg3 = estimate3;
#else
	*arg1 = CMath::InvSqrt( *arg1 );
	*arg2 = CMath::InvSqrt( *arg2 );
	*arg3 = CMath::InvSqrt( *arg3 );
#endif
}
...
inline void FastScalarInvSqrt_x6( float *arg1, float *arg2, float *arg3, float *arg4, float *arg5, float *arg6 ) {
	...
	*arg2 = CMath::InvSqrt( *arg2 );
	*arg3 = CMath::InvSqrt( *arg3 );
	*arg4 = CMath::InvSqrt( *arg4 );
	*arg5 = CMath::InvSqrt( *arg5 );
	*arg6 = CMath::InvSqrt( *arg6 );	
#endif
}
...
============
*/
void VPCALL idSIMD_AltiVec::Dot( float *dst, const CVector3D &constant, const CVector3D *src, const int count ) {
...
============
*/
void VPCALL idSIMD_AltiVec::Dot( float *dst, const CVector3D &constant, const CPlane *src, const int count ) {
//#define OPER(X) dst[(X)] = constant * src[(X)].Normal() + src[(X)][3];

	assert( sizeof(CPlane)  == PLANE_OFFSET * sizeof(float) );
...
============
*/
void VPCALL idSIMD_AltiVec::Dot( float *dst, const CVector3D &constant, const CDrawVertice *src, const int count ) {
//#define OPER(X) dst[(X)] = constant * src[(X)].xyz;
		
		// CDrawVertice size is 60 bytes
		assert( sizeof(CDrawVertice) == DRAWVERT_OFFSET * sizeof( float ) );
...
============
*/
void VPCALL idSIMD_AltiVec::Dot( float *dst, const CPlane &constant, const CVector3D *src, const int count ) {
//#define OPER(X) dst[(X)] = constant.Normal() * src[(X)] + constant[3];
		...
		CVector3D constNormal = constant.Normal();
...
============
*/
void VPCALL idSIMD_AltiVec::Dot( float *dst, const CPlane &constant, const CPlane *src, const int count ) {
...
============
*/
void VPCALL idSIMD_AltiVec::Dot( float *dst, const CPlane &constant, const CDrawVertice *src, const int count ) {
...
============
*/
void VPCALL idSIMD_AltiVec::Dot( float *dst, const CVector3D *src0, const CVector3D *src1, const int count ) {
...
void VPCALL idSIMD_AltiVec::CmpGT( SGF_Byte *dst, const float *src0, const float constant, const int count ) {
...
============
*/
void VPCALL idSIMD_AltiVec::CmpGT( SGF_Byte *dst, const SGF_Byte bitNum, const float *src0, const float constant, const int count ) {
...
============
*/
void VPCALL idSIMD_AltiVec::CmpGE( SGF_Byte *dst, const float *src0, const float constant, const int count ) {
...
============
*/
void VPCALL idSIMD_AltiVec::CmpGE( SGF_Byte *dst, const SGF_Byte bitNum, const float *src0, const float constant, const int count ) {
    register vector bool int vtbi0, vtbi1, vtbi2, vtbi3;
	register vector bool short vtbs0, vtbs1;
	register vector bool char vtbc0;
    register vector unsigned char vtuc0;
...
============
*/
void VPCALL idSIMD_AltiVec::CmpLT( SGF_Byte *dst, const float *src0, const float constant, const int count ) {
//#define OPER(X) dst[(X)] = src0[(X)] < constant;
    register vector float v0, v1, v2, v3;
    register vector bool int vr1, vr2, vr3, vr4;
	register vector bool short vs1, vs2;
...
============
*/
void VPCALL idSIMD_AltiVec::CmpLT( SGF_Byte *dst, const SGF_Byte bitNum, const float *src0, const float constant, const int count ) {
//#define OPER(X) dst[(X)] |= ( src0[(X)] < constant ) << bitNum;
    register vector bool int vtbi0, vtbi1, vtbi2, vtbi3;
	register vector bool short vtbs0, vtbs1;
	register vector bool char vtbc0;
...
============
*/
void VPCALL idSIMD_AltiVec::CmpLE( SGF_Byte *dst, const float *src0, const float constant, const int count ) {
//#define OPER(X) dst[(X)] = src0[(X)] <= constant;
    register vector float v0, v1, v2, v3;
    register vector bool int vr1, vr2, vr3, vr4;
	register vector bool short vs1, vs2;
...
============
*/
void VPCALL idSIMD_AltiVec::CmpLE( SGF_Byte *dst, const SGF_Byte bitNum, const float *src0, const float constant, const int count ) {
//#define OPER(X) dst[(X)] |= ( src0[(X)] <= constant ) << bitNum;
    register vector bool int vtbi0, vtbi1, vtbi2, vtbi3;
	register vector bool short vtbs0, vtbs1;
	register vector bool char vtbc0;
...
============
*/
void VPCALL idSIMD_AltiVec::MinMax( CVector2D &min, CVector2D &max, const CVector2D *src, const int count ) {
	min[0] = min[1] = CMath::INFINITY; max[0] = max[1] = -CMath::INFINITY;
//#define OPER(X) const CVector2D &v = src[(X)]; if ( v[0] < min[0] ) { min[0] = v[0]; } if ( v[0] > max[0] ) { max[0] = v[0]; } if ( v[1] < min[1] ) { min[1] = v[1]; } if ( v[1] > max[1] ) { max[1] = v[1]; }
...
============
*/
void VPCALL idSIMD_AltiVec::MinMax( CVector3D &min, CVector3D &max, const CVector3D *src, const int count ) {
	min[0] = min[1] = min[2] = CMath::INFINITY; max[0] = max[1] = max[2] = -CMath::INFINITY;
//#define OPER(X) const CVector3D &v = src[(X)]; if ( v[0] < min[0] ) { min[0] = v[0]; } if ( v[0] > max[0] ) { max[0] = v[0]; } if ( v[1] < min[1] ) { min[1] = v[1]; } if ( v[1] > max[1] ) { max[1] = v[1]; } if ( v[2] < min[2] ) { min[2] = v[2]; } if ( v[2] > max[2] ) { max[2] = v[2]; }
	...
	if ( count >= 4 ) {
		...
		for ( ; i+3 < count; i += 4 ) {
			...
			// put each CVector3D into its own vector as X Y Z (crap)
			vecSrc1 = vecLd1;
...
============
*/
void VPCALL idSIMD_AltiVec::MinMax( CVector3D &min, CVector3D &max, const CDrawVertice *src, const int count ) {
...
============
*/
void VPCALL idSIMD_AltiVec::MinMax( CVector3D &min, CVector3D &max, const CDrawVertice *src, const int *indexes, const int count ) {
	min[0] = min[1] = min[2] = CMath::INFINITY; max[0] = max[1] = max[2] = -CMath::INFINITY;
...
//#define OPER(X) dst[(X)] = src1[(X)] + src2[(X)]
    ...
    //know all data is 16-SGF_Byte aligned, so vectorize!
    for ( ; i+7 < count2; i += 8 ) {
		//load sources
		v0 = vec_ld( 0, &src1[i] );
		v1 = vec_ld( 16, &src1[i] );
...
void VPCALL idSIMD_AltiVec::MatX_LowerTriangularSolve( const CMatrizXD &L, float *x, const float *b, const int n, int skip ) {
...
============
*/
void VPCALL idSIMD_AltiVec::MatX_LowerTriangularSolveTranspose( const CMatrizXD &L, float *x, const float *b, const int n ) {
...
============
*/
bool VPCALL idSIMD_AltiVec::MatX_LDLTFactor( CMatrizXD &mat, CVectorXD &invDiag, const int n ) {
	int i, j, k, nc;
	float *v, *diag, *mptr;
...
============
*/
void VPCALL idSIMD_AltiVec::BlendJoints( CJointQuaternion *joints, const CJointQuaternion *blendJoints, const float lerp, const int *index, const int numJoints ) {
	int i;
	...
	if ( lerp >= 1.0f ) {
		...
		memcpy( joints[0].q.ToFloatPtr(), blendJoints[0].q.ToFloatPtr(), sizeof(CJointQuaternion) * numJoints );
		return;
	}
	...
	for ( i = 0; i+3 < numJoints; i+=4 ) {
		...
		// lerp is  v1 + l * ( v2 - v1 );	
		// the CVector3D T is going to be 12 bytes after the Q, so we can do this without calling ToFloatPtr() again. since its
...
void VPCALL idSIMD_AltiVec::ConvertJointQuatsToJointMats( CJointMatriz *jointMats, const CJointQuaternion *jointQuats, const int numJoints ) {
...
============
*/
void VPCALL idSIMD_AltiVec::ConvertJointMatsToJointQuats( CJointQuaternion *jointQuats, const CJointMatriz *jointMats, const int numJoints ) {
	...
	// bigger than 50% speedup, which is not too shabby. Should really replace CMath::InvSqrt with
...
============
*/
void VPCALL idSIMD_AltiVec::TransformJoints( CJointMatriz *jointMats, const int *parents, const int firstJoint, const int lastJoint ) {
	int i;
#if 0
...
============
*/
void VPCALL idSIMD_AltiVec::UntransformJoints( CJointMatriz *jointMats, const int *parents, const int firstJoint, const int lastJoint ) {
	int i;
#if 0
...
void VPCALL idSIMD_AltiVec::TransformVerts( CDrawVertice *verts, const int numVerts, const CJointMatriz *joints, const CVector4D *weights, const int *index, int numWeights ) {
	int i, j;
	...
	for( j = i = 0; i < numVerts; i++ ) {
		...
		float *matPtrOrig = ( *(CJointMatriz *)( jointsPtr + index[j*2] ) ).ToFloatPtr();
		...
		while( index[j*2+1] == 0 ) {
			j++;
			float *matPtr = ( *(CJointMatriz *)( jointsPtr + index[j*2] ) ).ToFloatPtr();
...
============
*/
void VPCALL idSIMD_AltiVec::TracePointCull( SGF_Byte *cullBits, SGF_Byte &totalOr, const float radius, const CPlane *planes, const CDrawVertice *verts, const int numVerts ) {
...
============
*/
void VPCALL idSIMD_AltiVec::DecalPointCull( SGF_Byte *cullBits, const CPlane *planes, const CDrawVertice *verts, const int numVerts ) {
...
============
*/
void VPCALL idSIMD_AltiVec::OverlayPointCull( SGF_Byte *cullBits, CVector2D *texCoords, const CPlane *planes, const CDrawVertice *verts, const int numVerts ) {
...
============
*/
void VPCALL idSIMD_AltiVec::DeriveTriPlanes( CPlane *planes, const CDrawVertice *verts, const int numVerts, const int *indexes, const int numIndexes ) {
	...
	for ( ; i < numIndexes; i += 3, j++ ) {
		...
		//CMath::RSqrt( n.x * n.x + n.y * n.y + n.z * n.z );
...
============
*/
void VPCALL idSIMD_AltiVec::DeriveTangents( CPlane *planes, CDrawVertice *verts, const int numVerts, const int *indexes, const int numIndexes ) {
	int i;
...
void VPCALL idSIMD_AltiVec::DeriveUnsmoothedTangents( CDrawVertice *verts, const dominantTri_s *dominantTris, const int numVerts ) {
...
============
*/
void VPCALL idSIMD_AltiVec::NormalizeTangents( CDrawVertice *verts, const int numVerts ) {
	...
	if ( i+3 < numVerts ) {
		// for loading normal from CDrawVertice
		...
		// for loading tangents from CDrawVertice
	...
	for ( ; i < numVerts; i++ ) {
		...
		for ( int j = 0; j < 2; j++ ) {
			CVector3D &t = verts[i].tangents[j];
...
void VPCALL idSIMD_AltiVec::CreateTextureSpaceLightVectors( CVector3D *lightVectors, const CVector3D &lightOrigin, const CDrawVertice *verts, const int numVerts, const int *indexes, const int numIndexes ) {
	...
	for ( i = 0; i+1 < numVerts; i+=2 ) {
		...
		const CDrawVertice *v2 = &verts[i+1];
		
		float x, y, z;
		float x2, y2, z2;
		CVector3D lightDir, lightDir2;
...
============
*/
void VPCALL idSIMD_AltiVec::CreateSpecularTextureCoords( CVector4D *texCoords, const CVector3D &lightOrigin, const CVector3D &viewOrigin, const CDrawVertice *verts, const int numVerts, const int *indexes, const int numIndexes ) {
...
============
*/
int VPCALL idSIMD_AltiVec::CreateShadowCache( CVector4D *vertexCache, int *vertRemap, const CVector3D &lightOrigin, const CDrawVertice *verts, const int numVerts ) {
	int outVerts = 0;
	int i = 0;
...
============
*/
int VPCALL idSIMD_AltiVec::CreateVertexProgramShadowCache( CVector4D *vertexCache, const CDrawVertice *verts, const int numVerts ) {
	...
	assert( sizeof(CDrawVertice) == DRAWVERT_OFFSET * sizeof(float) );
	// CVector4D size
	assert( sizeof(CVector4D) == IDVEC4_OFFSET * sizeof(float) );
...
void VPCALL idSIMD_AltiVec::MixedSoundToSamples( short *samples, const float *mixBuffer, const int numSamples ) {
    ...
    //unaligned at start, since samples is not 16-SGF_Byte aligned
