...
============
*/
void VPCALL CSIMD_Generic::Dot( float *dst, const CVector3D &constant, const CVector3D *src, const int count ) {
...
============
*/
void VPCALL CSIMD_Generic::Dot( float *dst, const CVector3D &constant, const CPlane *src, const int count ) {
...
============
*/
void VPCALL CSIMD_Generic::Dot( float *dst, const CVector3D &constant, const CDrawVertice *src, const int count ) {
...
============
*/
void VPCALL CSIMD_Generic::Dot( float *dst, const CPlane &constant, const CVector3D *src, const int count ) {
...
============
*/
void VPCALL CSIMD_Generic::Dot( float *dst, const CPlane &constant, const CDrawVertice *src, const int count ) {
...
============
*/
void VPCALL CSIMD_Generic::Dot( float *dst, const CVector3D *src0, const CVector3D *src1, const int count ) {
#define OPER(X) dst[(X)] = src0[(X)] * src1[(X)];
	UNROLL1(OPER)
#undef OPER
}
...
============
*/
void VPCALL CSIMD_Generic::CmpGT( SGF_Byte *dst, const float *src0, const float constant, const int count ) {
...
============
*/
void VPCALL CSIMD_Generic::CmpGT( SGF_Byte *dst, const SGF_Byte bitNum, const float *src0, const float constant, const int count ) {
...
============
*/
void VPCALL CSIMD_Generic::CmpGE( SGF_Byte *dst, const float *src0, const float constant, const int count ) {
#define OPER(X) dst[(X)] = src0[(X)] >= constant;
	UNROLL4(OPER)
#undef OPER
}
...
============
*/
void VPCALL CSIMD_Generic::CmpGE( SGF_Byte *dst, const SGF_Byte bitNum, const float *src0, const float constant, const int count ) {
#define OPER(X) dst[(X)] |= ( src0[(X)] >= constant ) << bitNum;
	UNROLL4(OPER)
#undef OPER
}
...
============
*/
void VPCALL CSIMD_Generic::CmpLT( SGF_Byte *dst, const float *src0, const float constant, const int count ) {
#define OPER(X) dst[(X)] = src0[(X)] < constant;
	UNROLL4(OPER)
#undef OPER
}
...
============
*/
void VPCALL CSIMD_Generic::CmpLT( SGF_Byte *dst, const SGF_Byte bitNum, const float *src0, const float constant, const int count ) {
#define OPER(X) dst[(X)] |= ( src0[(X)] < constant ) << bitNum;
	UNROLL4(OPER)
#undef OPER
}
...
============
*/
void VPCALL CSIMD_Generic::CmpLE( SGF_Byte *dst, const float *src0, const float constant, const int count ) {
#define OPER(X) dst[(X)] = src0[(X)] <= constant;
	UNROLL4(OPER)
#undef OPER
}
...
============
*/
void VPCALL CSIMD_Generic::CmpLE( SGF_Byte *dst, const SGF_Byte bitNum, const float *src0, const float constant, const int count ) {
#define OPER(X) dst[(X)] |= ( src0[(X)] <= constant ) << bitNum;
	UNROLL4(OPER)
#undef OPER
}
...
============
*/
void VPCALL CSIMD_Generic::MinMax( CVector2D &min, CVector2D &max, const CVector2D *src, const int count ) {
...
============
*/
void VPCALL CSIMD_Generic::MinMax( CVector3D &min, CVector3D &max, const CVector3D *src, const int count ) {
...
============
*/
void VPCALL CSIMD_Generic::MinMax( CVector3D &min, CVector3D &max, const CDrawVertice *src, const int count ) {
	min[0] = min[1] = min[2] = CMath::INFINITY; max[0] = max[1] = max[2] = -CMath::INFINITY;
#define OPER(X) const CVector3D &v = src[(X)].xyz; if ( v[0] < min[0] ) { min[0] = v[0]; } if ( v[0] > max[0] ) { max[0] = v[0]; } if ( v[1] < min[1] ) { min[1] = v[1]; } if ( v[1] > max[1] ) { max[1] = v[1]; } if ( v[2] < min[2] ) { min[2] = v[2]; } if ( v[2] > max[2] ) { max[2] = v[2]; }
	UNROLL1(OPER)
#undef OPER
}
...
============
*/
void VPCALL CSIMD_Generic::MinMax( CVector3D &min, CVector3D &max, const CDrawVertice *src, const int *indexes, const int count ) {
	min[0] = min[1] = min[2] = CMath::INFINITY; max[0] = max[1] = max[2] = -CMath::INFINITY;
#define OPER(X) const CVector3D &v = src[indexes[(X)]].xyz; if ( v[0] < min[0] ) { min[0] = v[0]; } if ( v[0] > max[0] ) { max[0] = v[0]; } if ( v[1] < min[1] ) { min[1] = v[1]; } if ( v[1] > max[1] ) { max[1] = v[1]; } if ( v[2] < min[2] ) { min[2] = v[2]; } if ( v[2] > max[2] ) { max[2] = v[2]; }
	UNROLL1(OPER)
#undef OPER
}
...
/*
================
CSIMD_Generic::Memcpy
================
*/
void VPCALL CSIMD_Generic::Memcpy( void *dst, const void *src, const int count ) {
...
============
*/
void VPCALL CSIMD_Generic::MatX_MultiplyVecX( CVectorXD &dst, const CMatrizXD &mat, const CVectorXD &vec ) {
	int i, j, numRows;
...
============
*/
void VPCALL CSIMD_Generic::MatX_MultiplyAddVecX( CVectorXD &dst, const CMatrizXD &mat, const CVectorXD &vec ) {
	int i, j, numRows;
	const float *mPtr, *vPtr;
	float *dstPtr;
...
============
*/
void VPCALL CSIMD_Generic::MatX_MultiplySubVecX( CVectorXD &dst, const CMatrizXD &mat, const CVectorXD &vec ) {
	int i, j, numRows;
	const float *mPtr, *vPtr;
	float *dstPtr;
...
============
*/
void VPCALL CSIMD_Generic::MatX_TransposeMultiplyVecX( CVectorXD &dst, const CMatrizXD &mat, const CVectorXD &vec ) {
	int i, j, numColumns;
	const float *mPtr, *vPtr;
	float *dstPtr;
...
============
*/
void VPCALL CSIMD_Generic::MatX_TransposeMultiplyAddVecX( CVectorXD &dst, const CMatrizXD &mat, const CVectorXD &vec ) {
	int i, j, numColumns;
	const float *mPtr, *vPtr;
	float *dstPtr;
...
============
*/
void VPCALL CSIMD_Generic::MatX_TransposeMultiplySubVecX( CVectorXD &dst, const CMatrizXD &mat, const CVectorXD &vec ) {
	int i, numColumns;
	const float *mPtr, *vPtr;
	float *dstPtr;
...
============
*/
void VPCALL CSIMD_Generic::MatX_MultiplyMatX( CMatrizXD &dst, const CMatrizXD &m1, const CMatrizXD &m2 ) {
	int i, j, k, l, n;
	float *dstPtr;
...
============
*/
void VPCALL CSIMD_Generic::MatX_TransposeMultiplyMatX( CMatrizXD &dst, const CMatrizXD &m1, const CMatrizXD &m2 ) {
	int i, j, k, l, n;
	float *dstPtr;
	const float *m1Ptr, *m2Ptr;
	double sum;
...
============
*/
void VPCALL CSIMD_Generic::MatX_LowerTriangularSolve( const CMatrizXD &L, float *x, const float *b, const int n, int skip ) {
#if 1
...
============
*/
void VPCALL CSIMD_Generic::MatX_LowerTriangularSolveTranspose( const CMatrizXD &L, float *x, const float *b, const int n ) {
#if 1
...
============
*/
bool VPCALL CSIMD_Generic::MatX_LDLTFactor( CMatrizXD &mat, CVectorXD &invDiag, const int n ) {
#if 1
...
============
*/
void VPCALL CSIMD_Generic::ConvertJointQuatsToJointMats( CJointMatriz *jointMats, const CJointQuaternion *jointQuats, const int numJoints ) {
	int i;
...
============
*/
void VPCALL CSIMD_Generic::ConvertJointMatsToJointQuats( CJointQuaternion *jointQuats, const CJointMatriz *jointMats, const int numJoints ) {
	int i;
...
============
*/
void VPCALL CSIMD_Generic::TransformJoints( CJointMatriz *jointMats, const int *parents, const int firstJoint, const int lastJoint ) {
	int i;
...
============
*/
void VPCALL CSIMD_Generic::UntransformJoints( CJointMatriz *jointMats, const int *parents, const int firstJoint, const int lastJoint ) {
	int i;
...
============
*/
void VPCALL CSIMD_Generic::TransformVerts( CDrawVertice *verts, const int numVerts, const CJointMatriz *joints, const CVector4D *weights, const int *index, int numWeights ) {
	int i, j;
...
============
*/
void VPCALL CSIMD_Generic::TracePointCull( SGF_Byte *cullBits, SGF_Byte &totalOr, const float radius, const CPlane *planes, const CDrawVertice *verts, const int numVerts ) {
	int i;
	SGF_Byte tOr;
...
============
*/
void VPCALL CSIMD_Generic::DecalPointCull( SGF_Byte *cullBits, const CPlane *planes, const CDrawVertice *verts, const int numVerts ) {
	int i;
...
============
*/
void VPCALL CSIMD_Generic::OverlayPointCull( SGF_Byte *cullBits, CVector2D *texCoords, const CPlane *planes, const CDrawVertice *verts, const int numVerts ) {
	int i;
...
============
*/
void VPCALL CSIMD_Generic::DeriveTriPlanes( CPlane *planes, const CDrawVertice *verts, const int numVerts, const int *indexes, const int numIndexes ) {
	int i;
...
============
*/
void VPCALL CSIMD_Generic::DeriveTangents( CPlane *planes, CDrawVertice *verts, const int numVerts, const int *indexes, const int numIndexes ) {
	int i;
...
/* s
void VPCALL CSIMD_Generic::DeriveUnsmoothedTangents( CDrawVertice *verts, const dominantTri_s *dominantTris, const int numVerts ) {
	int i;
...
void VPCALL CSIMD_Generic::NormalizeTangents( CDrawVertice *verts, const int numVerts ) {
...
============
*/
void VPCALL CSIMD_Generic::CreateTextureSpaceLightVectors( CVector3D *lightVectors, const CVector3D &lightOrigin, const CDrawVertice *verts, const int numVerts, const int *indexes, const int numIndexes ) {
...
============
*/
void VPCALL CSIMD_Generic::CreateSpecularTextureCoords( CVector4D *texCoords, const CVector3D &lightOrigin, const CVector3D &viewOrigin, const CDrawVertice *verts, const int numVerts, const int *indexes, const int numIndexes ) {
...
============
*/
int VPCALL CSIMD_Generic::CreateShadowCache( CVector4D *vertexCache, int *vertRemap, const CVector3D &lightOrigin, const CDrawVertice *verts, const int numVerts ) {
	int outVerts = 0;
...
============
*/
int VPCALL CSIMD_Generic::CreateVertexProgramShadowCache( CVector4D *vertexCache, const CDrawVertice *verts, const int numVerts ) {
	for ( int i = 0; i < numVerts; i++ ) {
		const float *v = verts[i].xyz.ToFloatPtr();
