...
============
*/
float SSE3_Dot( const CVector4D &v1, const CVector4D &v2 ) {
	float d;
#if defined(_MSC_VER)
	__asm {
		mov		esi, v1
...
============
*/
void VPCALL CSIMD_SSE3::TransformVerts( CDrawVertice *verts, const int numVerts, const CJointMatriz *joints, const CVector4D *weights, const int *index, const int numWeights ) {
#if 1
