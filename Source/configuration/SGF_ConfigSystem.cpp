...
namespace SGF {
	...
	//! depois de registrar as vari�eis estaticas seta o valor de staticvars para 0xFFFFFFFF
...
//! Cria um objeto Global de Configura��o da Engine,
//! que aarmazenar� as vari�veis globais
...
void CEngineSysVar::SetGlobal( const char *newValue, bool force, bool fromServer ) {
	...
	// se n�o houve mudan�a no valor, retorna
	if ( valueString.Icmp( newValue ) == 0 ) {
		return;
	}
	//se houve mudan�a no valor, continua
	valueString = newValue;
	m_pValue = valueString.c_str();
	UpdateValue();
...
\brief M�todo que muda o nome e valor de uma vari�vel registrada como internal Csysvar
\param name: nome da vari�vel
\param value: valor da vari�vel
\param m_iFlags: flags
\note Se a vari�vel interna n�o existir, ent�o ela � criada e adicionada � lista (registrada)
**/
...
void CGlobalConfiguration::Register( CSysVar &cvarToRegister ) {
	...
	//! se a vari�vel j� existe, apenas update do seu valor e avisa que � uma duplicata via debug
	if ( internal ) {
...
\brief M�todo que muda o nome e valor de uma vari�vel tipo String registrada como internal Csysvar
\param name: nome da vari�vel
\param value: valor da vari�vel
\param m_iFlags: flags
\note Se a vari�vel interna n�o existir, ent�o ela � criada e adicionada � lista (registrada)
...
\brief M�todo que muda o nome e valor de uma vari�vel tipo Bool registrada como internal Csysvar
\param name: nome da vari�vel
\param value: valor da vari�vel (bool)
\param m_iFlags: flags
\note Se a vari�vel interna n�o existir, ent�o ela � criada e adicionada � lista (registrada)
**/
...
\brief M�todo que muda o nome e valor de uma vari�vel tipo Integer registrada como internal Csysvar
\param name: nome da vari�vel
\param value: valor da vari�vel (integer)
\param m_iFlags: flags
\note Se a vari�vel interna n�o existir, ent�o ela � criada e adicionada � lista (registrada)
**/
...
\brief M�todo que muda o nome e valor de uma vari�vel tipo Float registrada como internal Csysvar
\param name: nome da vari�vel
\param value: valor da vari�vel (Float)
\param m_iFlags: flags
\note Se a vari�vel interna n�o existir, ent�o ela � criada e adicionada � lista (registrada)
**/
...
/** 
\brief M�todo que retorna o valor String de uma vari�vel CSysVar
\param name: nome da vari�vel
\note S� retorna o valor da vari�vel interna, aquela registada
**/
...
/** 
\brief M�todo que retorna o valor Bool de uma vari�vel CSysVar
\param name: nome da vari�vel
\note S� retorna o valor da vari�vel interna, aquela registada
**/
...
/** 
\brief M�todo que retorna o valor Integer de uma vari�vel CSysVar
\param name: nome da vari�vel
\note S� retorna o valor da vari�vel interna, aquela registada
**/
...
/** 
\brief M�todo que retorna o valor Float de uma vari�vel CSysVar
\param name: nome da vari�vel
\note S� retorna o valor da vari�vel interna, aquela registada
**/
...
void CGlobalConfiguration::CommandCompletion( void(*callback)( const char *s ) ) {
	for( int i = 0; i < m_globalSysVars.getNum(); i++ ) {
		callback( m_globalSysVars[i]->getName() ); //chama a fun��o de completar o comando com o nome da vari�vel como par�metro
	}
}
...
/** 
\brief M�todo que acha uma vari�vel registrada no vetor local da classe pelo nome
\param name: nome da vari�vel
\note Se a vari�vel Local n�o existir, retorna NULL
**/
...
/** 
\brief M�todo que muda o nome e valor interno de uma vari�vel Local d CLocal tipo CSysVar desta Classe
\param name: nome da vari�vel
\param value: valor da vari�vel
\param m_iFlags: flags
\note Se a vari�vel Local n�o existir, ent�o ela � criada e adicionada � lista (registrada)
**/
...
/** 
\brief M�todo que cria uma c�pia da ClocalSysvar e registra-a no vetor
\param cvarToRegister: refer�ncia da vari�vel a ser registrada
\note Se a vari�vel j� existir, ent�o ela � apenas atualizada
**/
void CConfiguration::Register( CSysVar &cvarToRegister ) {
	...
	//Se a vari�vel j� foi registrada, apenas faz o update
	//Sen�o, cria uma nova vari�vel interna e registra 
	if ( internal ) {
		internal->Update( &cvarToRegister );
	} else {
...
/** 
\brief M�todo que acha uma vari�vel CLocalSysVar Registrada anteriormente pelo seu nome
\param name: nome da vari�vel a ser encontrada
\note Se a vari�vel n�o existir, ent�o retorna NULL
**/
...
/** 
\brief M�todo que muda o nome e valor de uma vari�vel tipo String registrada como internal CLocalSysvar
\param name: nome da vari�vel
\param value: valor da vari�vel
\param m_iFlags: flags
\note Se a vari�vel interna n�o existir, ent�o ela � criada e adicionada � lista (registrada)
...
/** 
\brief M�todo que muda o nome e valor de uma vari�vel tipo Bool registrada como internal CLocalSysvar
\param name: nome da vari�vel
\param value: valor da vari�vel
\param m_iFlags: flags
\note Se a vari�vel interna n�o existir, ent�o ela � criada e adicionada � lista (registrada)
...
/** 
\brief M�todo que muda o nome e valor de uma vari�vel tipo Integer registrada como internal CLocalSysvar
\param name: nome da vari�vel
\param value: valor da vari�vel
\param m_iFlags: flags
\note Se a vari�vel interna n�o existir, ent�o ela � criada e adicionada � lista (registrada)
...
/** 
\brief M�todo que muda o nome e valor de uma vari�vel tipo Float registrada como internal CLocalSysvar
\param name: nome da vari�vel
\param value: valor da vari�vel
\param m_iFlags: flags
\note Se a vari�vel interna n�o existir, ent�o ela � criada e adicionada � lista (registrada)
...
/** 
\brief M�todo que retorna o valor String de uma vari�vel CLocalSysVar desta classe
\param name: nome da vari�vel
\note S� retorna o valor da vari�vel interna, aquela registada
**/
...
/** 
\brief M�todo que retorna o valor Bool de uma vari�vel CLocalSysVar desta classe
\param name: nome da vari�vel
\note S� retorna o valor da vari�vel interna, aquela registada
**/
...
/** 
\brief M�todo que retorna o valor Integer de uma vari�vel CLocalSysVar desta classe
\param name: nome da vari�vel
\note S� retorna o valor da vari�vel interna, aquela registada
**/
...
/** 
\brief M�todo que retorna o valor Float de uma vari�vel CLocalSysVar desta classe
\param name: nome da vari�vel
\note S� retorna o valor da vari�vel interna, aquela registada
**/
