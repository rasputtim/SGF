...
int SGF::CHashTableFast::INVALID_INDEX[1] = { -1 };
...
================
*/
void SGF::CHashTableFast::init( const int initialHashSize, const int initialIndexSize ) {
	assert( CMath::IsPowerOfTwo( initialHashSize ) );
...
================
*/
void SGF::CHashTableFast::allocate( const int newHashSize, const int newIndexSize ) {
	assert( CMath::IsPowerOfTwo( newHashSize ) );
...
================
*/
void SGF::CHashTableFast::freeMem() {
...
================
*/
void SGF::CHashTableFast::resizeIndex( const int newIndexSize ) {
...
================
*/
int SGF::CHashTableFast::getSpread() const {
