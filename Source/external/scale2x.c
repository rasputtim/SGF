...
static __inline void scale2x_8_def_single(scale2x_uint8* __restrict dst, const scale2x_uint8* __restrict src0, const scale2x_uint8* __restrict src1, const scale2x_uint8* __restrict src2, unsigned count)
{
	assert(count >= 2);
...
static __inline void scale2x_16_def_single(scale2x_uint16* __restrict dst, const scale2x_uint16* __restrict src0, const scale2x_uint16* __restrict src1, const scale2x_uint16* __restrict src2, unsigned count)
{
	assert(count >= 2);
...
static __inline void scale2x_32_def_single(scale2x_uint32* __restrict dst, const scale2x_uint32* __restrict src0, const scale2x_uint32* __restrict src1, const scale2x_uint32* __restrict src2, unsigned count)
{
	assert(count >= 2);
 ...
 *      %mm7 -> *current
 */
static __inline void scale2x_8_mmx_single(scale2x_uint8* dst, const scale2x_uint8* src0, const scale2x_uint8* src1, const scale2x_uint8* src2, unsigned count)
{
	assert(count >= 16);
	assert(count % 8 == 0);
...
static __inline void scale2x_16_mmx_single(scale2x_uint16* dst, const scale2x_uint16* src0, const scale2x_uint16* src1, const scale2x_uint16* src2, unsigned count)
{
	assert(count >= 8);
	assert(count % 4 == 0);
...
static __inline void scale2x_32_mmx_single(scale2x_uint32* dst, const scale2x_uint32* src0, const scale2x_uint32* src1, const scale2x_uint32* src2, unsigned count)
{
	assert(count >= 4);
	assert(count % 2 == 0);
